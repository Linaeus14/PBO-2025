...
public class App {
    public static void main(String[] args) {
        ...
        // contoh penggunaan non-static method
        App app = new App();
        app.displayMessage("This is a non-static method.");

        // contoh perbedaan antara static dan non-static method
    ...
    // Prosedur untuk menyapa pengguna
    public static void greetUser(String name) {
        System.out.println("Welcome, " + name + "!");
    }

    // Non-static method untuk menampilkan pesan
